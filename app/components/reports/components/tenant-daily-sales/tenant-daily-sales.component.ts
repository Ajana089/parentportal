...
@Component({
  selector: 'app-tenant-daily-sales',
  templateUrl: './tenant-daily-sales.component.html',
  styleUrl: './tenant-daily-sales.component.css'
})
export class TenantDailySalesComponent implements OnInit {
 ...
 loggedInUser: User;
  ...
  @ViewChild(MatSort) sort: MatSort;
    ...
    openDetails(element: any, day: string) {
      ...
      const dialogRef = this.dialog.open(TenantDaySalesComponent, {
            height: 'auto',
            width: '70%',
            minWidth: '70%',
  ...
  searchOrders() {
    ...
    if (this.month != '' && this.year != '')
    {
      this.loading = true;
      this.reportService
        .getTenantDailySales(this.month, this.year)
        .subscribe((res: any) => {
          if (res) {
            this.loading = false;
