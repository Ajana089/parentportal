...
@Component({
  selector: 'app-item-yearly-sales',
  templateUrl: './item-yearly-sales.component.html',
  styleUrl: './item-yearly-sales.component.css'
})
export class ItemYearlySalesComponent implements OnInit {
