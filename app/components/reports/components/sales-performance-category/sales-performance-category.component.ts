...
@Component({
  selector: 'app-sales-performance-category',
  templateUrl: './sales-performance-category.component.html',
  styleUrl: './sales-performance-category.component.css'
})
export class SalesPerformanceCategoryComponent implements OnInit {
 ...
 loggedInUser: User;
  ...
  searchOrders() {
    ...
    if (this.month != '' && this.year != '')
    {
      this.loading = true;
      this.reportService
        .getSalesCategoryProcessedData(this.month, this.year)
        .subscribe((res: any) => {
          if (res) {
            this.loading = false;
