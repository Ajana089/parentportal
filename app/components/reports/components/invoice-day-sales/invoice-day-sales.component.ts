...
@Component({
  selector: 'app-invoice-day-sales',
  templateUrl: './invoice-day-sales.component.html',
  styleUrl: './invoice-day-sales.component.css'
})
export class InvoiceDaySalesComponent {
