...
import { InventoryOrganizationAddComponent } from '../inventory-organization-add/inventory-organization-add.component';
...
@Component({
  ...
  styleUrl: './inventory-organization.component.css',
})
export class InventoryOrganizationComponent {
  ...
  editOrganizationID(data: any) {
    let dialogRef = this.dialog.open(DialogComponent, {
      ...
      minHeight: '100vh',
      data: {
        component: InventoryOrganizationAddComponent,
        title: 'Update Organization Master',
        id: data.ID,
      },
    });
